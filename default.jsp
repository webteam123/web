        ...
        <tr>
            <td>                
                <table rules="none" border="1" width="100%"  cellspacing="0" cellpadding="3" bordercolor="lightgrey" bordercolorlight="lightgrey" bordercolordark="white">
                    <tr height="30"><td style="text-indent:5px" background="images/index/classT.jpg"><b><font color="white">■ <bean:write name="classSingle" property="className"/></font></b></td></tr>
                    <tr bgcolor="#F9F9F9">
                		          		...
                		          		<logic:iterate id="boardSingle" name="class${classSingle.classId}" scope="session">
		    	        	                <table border="1" width="100%" cellspacing="0" cellpadding="4" bgcolor="#F9F9F9" bordercolor="#EEEEEE" bordercolorlight="#EEEEEE" bordercolordark="white" rules="cols">
        	    	       				        <tr height="35">
                    	        		            ...
                    	        		            <td><img src="images/index/btitle.jpg"> <a href="user/listShow.do?method=rootListShow&showpage=1&classId=${classSingle.classId}&boardId=${boardSingle.boardId}" type="underline" alt="进入版面！"><bean:write name="boardSingle" property="boardName" filter="false"/></a></td>
                    ...
                    <tr height="25"><td style="text-indent:10px" background="images/index/boardE.jpg"><font color="#F9F9F9)">论坛介绍：<bean:write name="classSingle" property="classIntro" filter="false"/></font></td></tr>
                </table>
            </td>
        </tr>
