...
<html>
  ...
  <body>
    <center>
          <table border="1" width="80%" bgcolor="#F9F9F9" cellspacing="0" cellpadding="0" bordercolor="lightgrey" bordercolorlight="lightgrey" bordercolordark="white" rules="none" style="margin-top:5px">
          <html:form action="user/reg.do">
          <input type="hidden" name="method" value="userReg">
          <input type="hidden" name="validate" value="yes">
	          <tr height="80">  <td colspan="5" style="text-indent:20px">■ 用户注册</td></tr>
	          <tr height="45">
	          ...
	          <tr height="45">
	                ...
	                <td rowspan="3" width="20%" valign="bottom" style="padding-bottom:10px">
	                    <img id="head" src="images/face/user/user0.gif" style="border:1px solid">
	                </td>
	          </tr>
	          <tr>
    	      		<td></td>
