  ...
  <body>
    <center>
      ...
      <table border="1" width="580" cellspacing="0" cellpadding="0" bordercolor="#E3E3E3" bordercolorlight="#E3E3E3" bordercolordark="white" rules="rows">
          <tr height="29"><td background="images/admin/backLT.jpg" colspan="5" style="text-indent:5px"><b><font color="white">■ 查看版面</font></b></td></tr>
              ...
              <tr>
                  ...
                  <logic:iterate id="backBoardSingle" name="backBoardList">
                      <tr height="35" bgcolor="#FBFBFB">
                            ...
                            <td width="40%" style="text-indent:5px"><a href="needLogin/admin/modifyBoard.do?method=modifyBoard&boardId=${backBoardSingle.boardId}"><bean:write name="backBoardSingle" property="boardName" filter="false"/></a></td>
