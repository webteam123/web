...
<html>
  ...
  <body>
    <center>
      <!-- 发表帖子 -->
	  <table border="1" width="99%" cellspacing="0" cellpadding="0" bordercolor="#E3E3E3" bordercolorlight="#E3E3E3" bordercolordark="white" rules="all" style="margin-top:8px">
      <html:form action="needLogin/addBbs.do" focus="bbsTitle">
          <input type="hidden" name="method" value="addBbs">
          <input type="hidden" name="validate" value="yes">
		  <tr bgcolor="#F0F0F0" height="30"><td colspan="2" style="text-indent:5px" background="images/index/classT.jpg"><b><font color="white">■ 发表帖子</font></b></td></tr>
          <tr>
              ...
              <td>
                  <table border="1" width="100%" cellspacing="0" cellpadding="0" bordercolor="#E3E3E3" bordercolorlight="#E3E3E3" bordercolordark="white" rules="rows">
                      ...
                      <tr height="30">
                          <td width="15%" align="center">【设置悬赏积分：】</td>
                          <td align="center"><html:text property="bbsjf" size="77" maxlength="35" styleId="title"/></td>
                      </tr>
