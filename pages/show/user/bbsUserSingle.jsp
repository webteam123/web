...
<html>
  ...
  <body>
    <center>
        <table border="1" width="70%" bgcolor="#F9F9F9" cellspacing="0" cellpadding="0" bordercolor="lightgrey" bordercolorlight="lightgrey" bordercolordark="white" rules="none" style="margin-top:8px">
	        <tr height="60">  <td colspan="2" style="text-indent:5px">■ 查看用户信息</td></tr>
 	        <tr height="50">
 	        	<td align="right">用户头像：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
 	        	<td><img src="images/face/user/${bbsUserSingle.userFace}" style="border:1px solid;border-color:#E0E0E0"></td>
 	        </tr>
 	        <tr height="50">
            ...
            <tr height="60"><td colspan="2" align="center" style="text-indent:20px"><html:button property="back" value="返回" onclick="javascript:window.history.go(-1)"/></td></tr>
        </table>
        <br>
    </center>
  </body>
