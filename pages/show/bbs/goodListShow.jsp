...
<html>
  ...
  <body>
    <center>
      <table border="1" width="100%" cellspacing="0" cellpadding="0" bordercolor="#E3E3E3" bordercolorlight="#E3E3E3" bordercolordark="white" rules="rows" style="margin-top:8px">
          <tr height="30"><td colspan="5" style="text-indent:5px" background="images/index/classT.jpg"><b><font color="white">■ 精华帖子</font></b></td></tr>
