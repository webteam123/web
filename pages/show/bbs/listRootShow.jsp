...
<html>
  ...
  <body>
    <center>
      ...
      <table border="1" width="100%" cellspacing="0" cellpadding="0" bordercolor="#E0E0E0" bordercolorlight="#E3E3E3" bordercolordark="white" rules="rows" style="margin-top:8px">
          ...
          <!-- ****************显示置顶帖子**************** -->
          <tr height="30"><td colspan="6" style="text-indent:5px" background="images/index/classT.jpg"><b><font color="white">■ 置顶帖子</font></b></td></tr>
                      ...
                      <td colspan="6">
                          <table border="1" width="100%" cellspacing="0" cellpadding="0" bordercolor="#F0F0F0" bordercolorlight="#F0F0F0" bordercolordark="white" rules="all">
                              ...
                              <logic:iterate id="topBbsSingle" name="topbbslist">
                                  <tr height="35" style="text-indent:5px" bgcolor="#FBFBFB">
                       			      <td width="8%" align="center">置顶</td>
			                          <td width="35%" style="text-indent:10px">
          ...
          <!-- ****************显示普通帖子**************** -->
          <tr height="30"><td colspan="6" style="text-indent:5px" background="images/index/classT.jpg"><b><font color="white">■ 其他帖子</font></b></td></tr>
			 	              ...
			 	              <!-- 遍历普通帖子列表 -->
                  		      <logic:iterate id="otherBbsSingle" name="otherbbslist">
			                      <tr height="35" bgcolor="#F9F9F9">
			                          ...
			                          <!-- 输出帖子标题 -->
            			              <td style="text-indent:10px" width="35%">
                                      ...
                                      <c:forEach var="row" items="${result.rows}">
                                          <c:if test="${sessionScope.logoner.userName==otherBbsSingle.bbsSender||row.user_able==2}">
