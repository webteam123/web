  ...
  <body>
    <center>
      ...
      <table border="1" width="580" cellspacing="0" cellpadding="0" bordercolor="#E3E3E3" bordercolorlight="#E3E3E3" bordercolordark="white" rules="rows">
          <tr height="29"><td background="images/admin/backLT.jpg" colspan="6" style="text-indent:5px"><b><font color="white">■ 查看用户</font></b></td></tr>
              ...
              <tr>
                  ...
                  <logic:iterate id="backUserSingle" name="backUserList" indexId="ind">
                      <tr height="35" bgcolor="#FBFBFB">
                          ...
                          <td width="30%" style="text-indent:5px"><a href="needLogin/admin/modifyUser.do?method=modifyUser&userId=${backUserSingle.id}"><bean:write name="backUserSingle" property="userName" filter="false"/></a></td>
