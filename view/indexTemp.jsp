...
<html>
  ...
  <body bgcolor="lightgrey">
    <center>
      <table bgcolor="#F0F0F0" border="0" width="90%" cellspacing="0" cellpadding="0" bordercolor="lightgrey" bordercolorlight="lightgrey" bordercolordark="white">
