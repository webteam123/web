  ...
  <body>
    <center>
      ...
      <table border="1" width="99%" cellspacing="0" cellpadding="0" bordercolor="#E3E3E3" bordercolorlight="#E0E0E0" bordercolordark="white" rules="all" style="margin-top:8px;word-break:break-all">
          <tr height="30"><td colspan="3" background="images/index/classT.jpg" style="text-indent:5px"><b><font color="white">■ 显示根帖</font></b></td></tr>
          ...
          <tr height="130"><td colspan="2" valign="top" style="padding-top:6px;padding-left:6px;padding-right:6px;padding-bottom:6px"><bean:write name="bbsRootSingle" property="bbsContent" scope="session" filter="false"/></td></tr>
