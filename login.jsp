  ...
  <body bgcolor="#AA8D60">
    <center>
      <html:form action="user/login.do" focus="userName">
          ...
          <table background="images/login/loginB.jpg" width="500" height="300" border="0" cellspacing="0" cellpadding="0" style="margin-top:90px">
              <tr height="175">
                  <td colspan="2" style="text-indent:145px">
                      <html:errors/>
