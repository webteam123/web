  ...
  <body>
    <center>
      ...
      <table border="1" width="580" cellspacing="0" cellpadding="0" bordercolor="#E3E3E3" bordercolorlight="#E3E3E3" bordercolordark="white" rules="rows">
          <tr height="29"><td background="images/admin/backLT.jpg" colspan="4" style="text-indent:5px"><b><font color="white">■ 查看论坛类别</font></b></td></tr>
	      <tr height="30" bgcolor="#F0F0F0">
	          <td width="20%" align="center">类别ID</td>
	          <td width="60%" style="text-indent:15px">类别名称</td>
              ...
              <tr>
	              ...
	              <logic:iterate id="backClassSingle" name="backClassList">
    	              <tr height="30" bgcolor="#FBFBFB">
	                      ...
	                      <td width="60%" style="text-indent:15px"><a href="needLogin/admin/modifyClass.do?method=modifyClass&classId=${backClassSingle.classId}"><bean:write name="backClassSingle" property="className" filter="false"/></a></td>
